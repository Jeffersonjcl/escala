...
$query = $pdo->query("SELECT * FROM notas where id = '$id'");
...
if(@$_FILES['arquivo_conta']['name'] != ""){
	...
	if($ext == 'png' or $ext == 'jpg' or $ext == 'jpeg' or $ext == 'xlsx' or $ext == 'xlsm' or $ext == 'xls' or $ext == 'gif' or $ext == 'pdf' or $ext == 'rar' or $ext == 'zip' or $ext == 'doc' or $ext == 'docx' or $ext == 'txt' or $ext == 'xlsx' or $ext == 'xlsm' or $ext == 'xls' or $ext == 'xml' ){ 
