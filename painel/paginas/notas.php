...
<div class="justify-content-between">
	<div class="left-content mt-2 mb-3">
		<form action="rel/lista_notas_class.php" target="_blank" method="POST">
			<div class="left-content mt-2 mb-3">
				...
				<select class="form-select sel3" name="filtroCliente" id="filtroCliente" style="width:190px" onchange="buscar()">
				...
				<div style="display: inline-block; padding-left: 10px;" title="Filtrar por Status">
				...
				<button style="position:absolute; right:107px; margin-top: 20px;" class="btn btn-danger esc botao_rel" type="submit">Relatório<i class="fa fa-file-pdf-o ms-2"></i></button>
				...
				<a style="position:absolute; right:240px; margin-top: 20px;" href="rel/excel_notas.php" type="button" class="btn btn-success esc botao_rel" target="_blank">Relatório<span class="fa fa-file-excel-o ms-2"></span></a>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4 mb-6">
							<div id="divImg">
								<img src="images/notas/sem-foto.png" width="100px" id="target">
							</div>
						</div>
...
<script type="text/javascript">
	...
	function buscar() {
		...
		listar(dataInicial, dataFinal, status, filtroCliente);
