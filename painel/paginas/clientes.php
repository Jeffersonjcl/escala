			...
			<form id="form">
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-3 col-6 needs-validation was-validated">
					...
					<div class="row">
						...
						<div class="col-md-3 mb-2 col-6">
							<label>Pessoa</label>
							<select name="tipo_pessoa" id="tipo_pessoa" class="form-select" onchange="mudarPessoa()" required>
						...
						<div class="col-md-3 mb-2 col-6">
							<label id="label_pessoa">CPF / CNPJ</label>
				...
				<div class="modal-footer">
					<button type="submit" id="btn_salvar" class="btn btn-success"><i class="fa-solid fa-check ms-2"></i> Salvar</button>
				</div>
							...
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										...
										<tr>
											<td width="35%" class="bg-primary text-white w_150">Telefone</td>
											<td><span id="telefone_dados"></span></td>
										</tr>

										<tr>
											<td class="bg-primary text-white w_150">Email</td>
						...
						<div class="col-md-6">
							<div class="tile">
								<div class="table-responsive">
									<table id="" class="text-left table table-bordered">
										<tr>
											<td width="35%" class="bg-primary text-white w_150">CEP</td>
										...
										<tr>
											<td class="bg-primary text-white w_150">Nacionalidade</td>
		...
		<div class="modal-content">
			...
			<form id="form-arquivos" method="post">
				<div class="modal-body">
					...
					<hr style="border: none; height: 1px; background: linear-gradient(to right, rgb(13, 106, 252), red);">
...
<script type="text/javascript">
	...
	function mudarPessoa() {
		...
		if (pessoa == "") {
			$('#label_pessoa').text('CPF / CNPJ');
			$('#cpf').val('');
			$('#cpf').attr('placeholder', 'CPF / CNPJ');
		} else if (pessoa == 'Física') {
...
<script type="text/javascript">
	...
	function totalizar() {
		...
		$('#subtotal').val(subtotal.toLocaleString('pt-br', {minimumFractionDigits: 2}));
