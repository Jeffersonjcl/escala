...
//Calcula a Comissao
$valor_comissao = $valor * ($porc_comissao / 100);


if ($valor == $valor_antigo) {

	$pdo->query("UPDATE $tabela SET saida = '$saida', usuario_pgto = '$id_usuario', pago = 'Sim', valor = '$subtotal', data_pgto = '$data_baixar', comissao = '$valor_comissao', porc_comissao = '$porc_comissao' where id = '$id'");

	$pdo->query("UPDATE notas SET status = 'Faturada' WHERE id = '$id_ref'");
	...
	$pdo->query("UPDATE $tabela set saida = '$saida', usuario_pgto = '$id_usuario', valor = '$valor_antigo', data_pgto = curDate(), comissao = '$valor_comissao', porc_comissao = '$porc_comissao' where id = '$id'");
