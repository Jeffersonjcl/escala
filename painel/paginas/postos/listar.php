...
HTML;
	...
	echo 'Não encontrei nenhum Posto/Graduação cadastrado!';
}
...
<div class="dropdown" style="display: inline-block;">
		<a class="btn btn-danger btn-sm" href="#" aria-expanded="false" aria-haspopup="true" data-bs-toggle="dropdown" class="dropdown" title="Excluir Posto/Graduação"><i class="fa fa-trash-can"></i> </a>
