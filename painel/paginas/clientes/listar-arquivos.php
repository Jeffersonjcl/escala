			...
			<tr>					
				...
				<td>
					...
					<div class="dropdown" style="display: inline-block;">                      
                        ...
                        <p><b>Confirmar Exclusão?</b> <a href="#" onclick="excluirArquivo('{$id}', '{$nome}')"><span class="text-danger"  style="text-decoration: none;" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'"><b>Sim</b></span></a></p>
                        </div>
                        </div>
                        </div>
