...
HTML;
	...
	echo 'Não encontei nenhum Cargo cadastrado!';
}
...
<div class="dropdown" style="display: inline-block;">                      
		<a class="btn btn-danger btn-sm" href="#" aria-expanded="false" aria-haspopup="true" data-bs-toggle="dropdown" class="dropdown" title="Excluir Cargo"><i class="fa fa-trash-can"></i> </a>
