...
if ($valor > $valor_antigo) {
	echo 'O valor a ser pago não pode ser superior ao valor total da conta! O valor atual da conta é de R$ ' . $valor_antigo;
	exit();
}

if ($valor <= 0) {
	echo 'Ops! O valor da sua conta precisa ser maior que 0 ';
	exit();
}
