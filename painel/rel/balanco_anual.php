...
<body>
	...
	<div id="footer" class="row">
		...
		<table style="width:100%;">
			<tr style="width:100%;">
				<td style="width:94%; font-size: 10px; text-align: left;"> <?php echo mb_convert_case($nome_sistema, MB_CASE_TITLE, 'UTF-8') ?> - Telefone: <?php echo $telefone_sistema ?></td>
				<td style="width:6%; font-size: 10px;">
					<p style="text-align: right;" class="page">Página </p>
				</td>
			</tr>
		</table>
	</div>
