...
<table class="printer-ticket">
	...
	<tbody>
			...
			<tr>
					...
					<td colspan="2" width="70%"> Eu, <?php echo $nome_pessoa ?>, atesto que recebi da empresa <?php echo $nome_sistema ?> a quantia de <b>R$ <?php echo $valorF ?> (<?php echo valor_por_extenso($valor_extenso1)?> <?php echo $valor_extenso2 ?>) </b> na data do dia <?php echo $dataF ?>.
					</td>	
