...
if ($filtro_lancamento != "") {
	if ($filtro_lancamento == 'Conta') {
		...
		$classe_entradas = '';
	} else if ($filtro_lancamento == 'Comissao') {
	...
	<div id="header">
		...
		<div style="border-style: solid; font-size: 10px; height: 55px;">
			<table style="width: 100%; border: 0px solid #ccc;">
				<tr>
					<td style="border: 1px; width: 50%; text-align: left;">
					...
					<td style="width: 47%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>RELATÓRIO DE <span style="color:<?php echo $classe_entradas ?>"><?php echo $filtro_tipoF ?> <?php if ($filtro_lancamentoF != "") {
																																echo '(' . mb_strtoupper($filtro_lancamentoF) . ')';
																															} ?></span></big></b><br> <?php echo mb_strtoupper($texto_filtro) ?> <br> <?php echo mb_strtoupper($data_hoje) ?>
					</td>
				</tr>
			</table>
		</div>
