...
<body>
			...
			<table style="width: 100%; border: 0px solid #ccc;">
				<tr>
					<td style="border: 1px; width: 50%; text-align: left;">
						<img style="margin-top: 5px; margin-left: 7px;" id="imag" src="<?php echo $url_sistema ?>img/logo.jpg" width="150px">
					</td>
	...
	<div class="col-md-12 p-2">
		<div class="" align="center" style="margin-right: 20px; margin-top: 350px;">

			<img src="<?php echo $url_sistema ?>/painel/images/<?php echo $classe_img ?>" width="200px">
