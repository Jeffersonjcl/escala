...
$query = $pdo->prepare("SELECT * from usuarios where email = :email or telefone = :usuario2 or telefone = :email order by id asc limit 1");
...
if ($linhas > 0) {
	...
	if ($res[0]['ativo'] != 'Sim') {
		...
		echo '<script>window.location="receber"</script>';
	}
